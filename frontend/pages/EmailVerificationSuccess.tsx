      ...
      <main className="min-h-screen flex items-center justify-center bg-blue-50 px-4">
        <div className="bg-white p-8 rounded shadow-md text-center max-w-md w-full">
          ...
          <p className="text-gray-700 mb-6">
            ...
            <Link href="/login" className="inline-block text-white bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
              Go to Login
          </Link>
        </div>
      </main>
